    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('1', 'Toys'), ('2', 'Fashion'), ('3', 'Electronics'), ('4', 'Home'), ('5', 'Pets'), ('6', 'Others')], max_length=64)),
                ...
                ('watching', models.ManyToManyField(blank=True, related_name='watch_users', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
